...
$query = "SELECT user.f_name,user.l_name,user.profile_pic,follow.date_since,user.user_name FROM user INNER JOIN follow on user.user_id=follow.followed WHERE follow.follower=".$id;
