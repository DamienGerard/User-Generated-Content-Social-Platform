...
$url2 = 'http://localhost/UniWebProject/processFollowings.php?id='.$id;
        ...
        $("#cover-image").click(function(){
            ...
            <div style="width:100%; dsplay:flex;">
                <div class="tabinator" style="float:left; width:75%;">
                    ...
                    <label for="tab1">Follower</label>
                    <input type="radio" id="tab2" name="tabs">
                    <label for="tab2">Followings</label>
                    ...
                    <div id="content1">
                        ...
                        foreach($json1 as $follower){
                            ...
                            $followerUsername = $follower->user_name;
                                ...
                                echo '<div style="background-color:lightgrey; border-radius: 5px; border: 3px solid black; height:100px; overflow:hidden">';
                                echo '<table>';
                                echo '<tr>';
