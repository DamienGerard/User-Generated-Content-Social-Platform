...
<body>
    ...
    <div class="super-main">
        ...
        <div class="main">
        <div class="generic-btn" style="display:block; width:80px; margin-bottom: 5px;"><a href="video_main.php" class="anchor-list-item"> <h3 style="margin: 0; padding: 0;">Videos</h3> </a></div>
                <?php
