...
<?php include 'navbar.php';?>
    ...
    <?php include 'side_column.php';?>
        ...
        <div class="main">
            ...
            <?php
                $query = 'SELECT * FROM webprojectdatabase.picture INNER JOIN webprojectdatabase.content ON content.content_id = picture.picture_id INNER JOIN webprojectdatabase.user ON user.user_id = content.user_id WHERE content.marked=0 ORDER BY content.date DESC';
